...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (newsletter) { // Check to see if the element exists
    // Function used to see if the element is in the viewport
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (aboutContainer) { // Check if the element exists
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (preparationContainer) { // Check if the element exists
    setTimeout(function() {
